...
//var web3 = new Web3(Web3.givenProvider || 'http://127.0.0.1:7545');
    ...
    $('#form1').on('submit', function(event) {
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          ...
          .then(receipt => {
              var msg="<h5 style='color: green'><b>New Batch Added Successfully</b></h5><p> Vaccine Shipment ID: "+receipt.events.Added.returnValues[0]+"</p>";
              prodid = receipt.events.Added.returnValues[0];
              qr.value = receipt.events.Added.returnValues[0];
              $bottom="<p style='color: black'> Generated QR Code for Shipment </p>"
              $("#alertText").html(msg);
              $("#qrious").show();
